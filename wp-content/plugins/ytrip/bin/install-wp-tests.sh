...
#
# Installs the WordPress testing library for running PHPUnit tests.
#
# Usage:
#   bash bin/install-wp-tests.sh <db-name> <db-user> <db-pass> [db-host] [wp-version]
#
# Example:
#   bash bin/install-wp-tests.sh wp_tests root root localhost latest
#
# @package YTrip
# @since 2.1.0
# =============================================================================
...
# Determine WordPress version from API
...
install_test_suite() {
    ...
    if [ ! -f wp-tests-config.php ]; then
        ...
        # Remove all forward slashes from path
