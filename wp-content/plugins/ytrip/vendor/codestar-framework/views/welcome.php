...
if ( ! class_exists( 'CSF_Welcome' ) ) {
  class CSF_Welcome{
    ...
    public function set_demo_mode() {
      ...
      if ( ! empty( $demo_mode ) ) {
echo 'xxxxxxxxxxxxxx';
        CSF::include_plugin_file( 'options/admin-options.php' );

        if ( CSF::$premium ) {

          CSF::include_plugin_file( 'options/customize-options.php' );
          CSF::include_plugin_file( 'options/metabox-options.php'   );
          CSF::include_plugin_file( 'options/nav-menu-options.php'  );
          CSF::include_plugin_file( 'options/profile-options.php'   );
          CSF::include_plugin_file( 'options/shortcode-options.php' );
          CSF::include_plugin_file( 'options/taxonomy-options.php'  );
          CSF::include_plugin_file( 'options/widget-options.php'    );
          CSF::include_plugin_file( 'options/comment-options.php'   );
