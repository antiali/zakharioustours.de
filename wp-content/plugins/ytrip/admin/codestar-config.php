...
CSF::createSection( $prefix, array(
    'title'  => 'GitHub Integration | تكامل GitHub',
    'icon'   => 'fa fa-github',
    'fields' => array(
        array(
            'id'      => 'github_repo',
            'type'    => 'text',
            'title'   => 'GitHub Repository | مستودع GitHub',
            'desc'    => 'Enter your GitHub repository (e.g., username/repo-name)',
            'default' => '',
            'placeholder' => 'antiali/zakharioustours.de',
        ),
        array(
            'id'      => 'github_token',
            'type'    => 'password',
            'title'   => 'GitHub Token | رمز GitHub',
            'desc'    => 'Enter your GitHub Personal Access Token with repo permissions',
            'default' => '',
        ...
        array(
            'type'    => 'submessage',
            'style'   => 'info',
            'content' => '<strong>How to create a GitHub Token:</strong><br>1. Go to GitHub → Settings → Developer settings → Personal access tokens<br>2. Click "Generate new token" (classic)<br>3. Select "repo" permissions<br>4. Copy the token and paste here',
        ),
    ),
) );
...
// Section 8: Debugging
CSF::createSection( $prefix, array(
    'title'  => 'Debugging | التصحيح',
    'icon'   => 'fa fa-bug',
    'fields' => array(
        array(
            'id'      => 'debug_mode',
            'type'    => 'switcher',
            'title'   => 'Enable Debug Mode | تفعيل وضع التصحيح',
            'desc'    => 'Enable detailed error logging and debug information',
            'default' => false,
        ),
        array(
            'id'      => 'debug_log_level',
            'type'    => 'select',
            'title'   => 'Debug Log Level | مستوى التسجيل',
            'desc'    => 'Select how much information to log',
            'options' => array(
                'error'   => 'Errors Only | الأخطاء فقط',
                'warning' => 'Errors + Warnings | أخطاء وتحذيرات',
                'info'    => 'All Info | كل المعلومات',
            ),
            'default' => 'error',
            'dependency' => 'debug_mode', // Only show if debug_mode is enabled
        ),
        array(
            'id'      => 'log_to_file',
            'type'    => 'switcher',
            'title'   => 'Log to File | التسجيل في ملف',
            'desc'    => 'Save debug logs to wp-content/debug.log',
            'default' => false,
            'dependency' => 'debug_mode',
        ),
        array(
            'type'    => 'submessage',
            'style'   => 'warning',
            'content' => '<strong>⚠️ Warning:</strong> Debug mode should be disabled in production environments for security and performance.',
        ),
    ),
) );
